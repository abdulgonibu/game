    ...
    <body style="background-color: #387D71;" data-new-gr-c-s-check-loaded="14.1068.0" data-gr-ext-installed="">
        <div class="body_wp" style="width: 100%;display: flex;justify-content: center;margin-top: 170px;">
            <div class="centerisssze_game">
                <div class="head">Tin Patti</div>
                <center><img src="{{ asset('FILE/IMAGE/teenpaty.png') }}" alt="" id="result_one"></center>
                <center><img src="{{ asset('FILE/IMAGE/coin_toss.gif') }}" alt="" id="result_two" style="display:none"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/teen/win/1.png') }}" alt="" id="win1" style="display:none"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/teen/win/2.png') }}" alt="" id="win2" style="display:none"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/teen/loss/1.png') }}" alt="" id="loss1" style="display:none"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/teen/loss/2.png') }}" alt="" id="loss2" style="display:none"></center>

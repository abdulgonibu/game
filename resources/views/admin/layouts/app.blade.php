        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="{{ route('admin.index') }}" class="logo">
                        <span>
                            <h4 class="text-white pt-2"><strong>WinTk71.com</strong></h4>
                        </span>
                        <i>
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            <li class="menu-title">WinTk71.com</li>
                            <li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fi-head"></i> <span> User List</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('users.index') }}">View All</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fa-solid fa-money-check-dollar"></i> <span> Deposit List</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('deposit.index') }}">Deposit List</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fa-solid fa-money-check-dollar"></i> <span> Withdrow List</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('withdrow.index') }}">Withdrow List</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fa-solid fa-bookmark"></i> <span> Manage review</span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{ route('review.create') }}">Create New</a></li>
                                    <li><a href="{{ route('review.index') }}">View All</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript: void(0);"><i class="fa-solid fa-gear"></i> <span> Website settings </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
            ...
            <div class="content-page">
                ...
                <footer class="footer text-right">
                    @php echo date('Y'); @endphp © WinTk71.com
                </footer>

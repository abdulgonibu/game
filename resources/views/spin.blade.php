    ...
    <body style="background-color: #387D71;" data-new-gr-c-s-check-loaded="14.1068.0" data-gr-ext-installed="">
        <div class="body_wp" style="width: 100%;display: flex;justify-content: center;margin-top: 170px;">
            <div class="centerisssze_game">
                <div class="head">Lucky Spin</div>
                <center><img src="{{ asset('FILE/IMAGE/spin_logo.png') }}" alt="" id="result_one"></center>
                <center><img src="{{ asset('FILE/IMAGE/EpAsP.gif') }}" alt="" id="result_two" style="display:none"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/win/1.png') }}" alt="" id="win1" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/win/2.png') }}" alt="" id="win2" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/win/3.png') }}" alt="" id="win3" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/win/4.png') }}" alt="" id="win4" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/win/5.png') }}" alt="" id="win5" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/win/6.png') }}" alt="" id="win6" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/loss/1.png') }}" alt="" id="loss1" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/loss/2.png') }}" alt="" id="loss2" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/loss/3.png') }}" alt="" id="loss3" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/loss/4.png') }}" alt="" id="loss4" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/loss/5.png') }}" alt="" id="loss5" style="display:none;width: 200px;"></center>
                <center><img src="{{ asset('FILE/IMAGE/result/lucky_spin/loss/6.png') }}" alt="" id="loss6" style="display:none;width: 200px;"></center>
                <div class="all_controls">
                    <br>
                    <div class="result">
                    <span id="result_text">Balance insufficient</span>
                    </div>
                    <p id="ti">Select an option</p>
                    <div class="flex">
